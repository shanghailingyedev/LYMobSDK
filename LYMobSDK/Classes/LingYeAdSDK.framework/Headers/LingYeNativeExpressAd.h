...
#import <LingYeAdSDK/LingYeNativeAdObject.h>
#import <LingYeAdSDK/LingYeAdMaterial.h>
@class LingYeNativeExpressAd;

NS_ASSUME_NONNULL_BEGIN

@interface LingYeNativeExpressAd : NSObject

// 自渲染广告对象
@property(nonatomic,strong) LingYeNativeAdObject *adObject;
// 模板视图
