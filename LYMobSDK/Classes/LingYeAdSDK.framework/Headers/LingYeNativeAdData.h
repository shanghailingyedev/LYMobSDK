...
@class LingYeAdMaterial;

NS_ASSUME_NONNULL_BEGIN

@interface LingYeMediaInfo: NSObject
/// 素材宽
...
@interface LingYeNativeAdData : NSObject
...
/// 素材地址
@property (nonatomic, strong, readonly) NSArray <LingYeMediaInfo *> *imageUrls;
/// 视频类素材描述
@property (nonatomic, strong, readonly) LingYeMediaInfo *videoAdInfo;
