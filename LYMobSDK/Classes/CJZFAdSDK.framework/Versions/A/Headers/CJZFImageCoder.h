...
#import "CJZFImageFrame.h"

typedef NSString * CJZFImageCoderOption NS_STRING_ENUM;
typedef NSDictionary<CJZFImageCoderOption, id> CJZFImageCoderOptions;
typedef NSMutableDictionary<CJZFImageCoderOption, id> CJZFImageCoderMutableOptions;
...
/**
 ...
 @note works for `CJZFImageCoder`.
 */
FOUNDATION_EXPORT CJZFImageCoderOption _Nonnull const CJZFImageCoderDecodeFirstFrameOnly;
...
/**
 ...
 @note works for `CJZFImageCoder`, `CJZFProgressiveImageCoder`, `CJZFAnimatedImageCoder`.
 */
FOUNDATION_EXPORT CJZFImageCoderOption _Nonnull const CJZFImageCoderDecodeScaleFactor;
...
/**
 ...
 @note works for `CJZFImageCoder`, `CJZFProgressiveImageCoder`, `CJZFAnimatedImageCoder`.
 */
FOUNDATION_EXPORT CJZFImageCoderOption _Nonnull const CJZFImageCoderDecodePreserveAspectRatio;
...
/**
 ...
 @note works for `CJZFImageCoder`, `CJZFProgressiveImageCoder`, `CJZFAnimatedImageCoder`.
 */
FOUNDATION_EXPORT CJZFImageCoderOption _Nonnull const CJZFImageCoderDecodeThumbnailPixelSize;
 ...
 */
FOUNDATION_EXPORT CJZFImageCoderOption _Nonnull const CJZFImageCoderDecodeFileExtensionHint;
 ...
 */
FOUNDATION_EXPORT CJZFImageCoderOption _Nonnull const CJZFImageCoderDecodeTypeIdentifierHint;
...
/**
 ...
 @note works for `CJZFImageCoder`, `CJZFProgressiveImageCoder`, `CJZFAnimatedImageCoder`.
 */
FOUNDATION_EXPORT CJZFImageCoderOption _Nonnull const CJZFImageCoderDecodeUseLazyDecoding;
...
/**
 ...
 @note You can use the logic from `+[CJZFImageCoder scaledSizeWithImageSize:limitBytes:bytesPerPixel:frameCount:]`
 @note This option has higher priority than `.decodeThumbnailPixelSize`
 */
FOUNDATION_EXPORT CJZFImageCoderOption _Nonnull const CJZFImageCoderDecodeScaleDownLimitBytes;
...
/**
 ...
 @note works for `CJZFImageCoder`.
 */
FOUNDATION_EXPORT CJZFImageCoderOption _Nonnull const CJZFImageCoderEncodeFirstFrameOnly;
/**
 ...
 @note works for `CJZFImageCoder`
 */
FOUNDATION_EXPORT CJZFImageCoderOption _Nonnull const CJZFImageCoderEncodeCompressionQuality;
...
/**
 ...
 @note works for `CJZFImageCoder`
 */
FOUNDATION_EXPORT CJZFImageCoderOption _Nonnull const CJZFImageCoderEncodeBackgroundColor;
...
/**
 ...
 @note works for `CJZFImageCoder`
 */
FOUNDATION_EXPORT CJZFImageCoderOption _Nonnull const CJZFImageCoderEncodeMaxFileSize;
...
/**
 ...
 @note works for `CJZFImageCoder`
 */
FOUNDATION_EXPORT CJZFImageCoderOption _Nonnull const CJZFImageCoderEncodeEmbedThumbnail;

/**
 A CJZFWebImageContext object which hold the original context options from top-level API. (CJZFWebImageContext)
 ...
 Only the unknown context from top-level API (See CJZFWebImageDefine.h) may be passed in during image loading.
 See `CJZFWebImageContext` for more detailed information.
 @warning Deprecated. This does nothing from 5.14.0. Use `CJZFWebImageContextImageDecodeOptions` to pass additional information in top-level API, and use `CJZFImageCoderOptions` to retrieve options from coder.
 */
FOUNDATION_EXPORT CJZFImageCoderOption _Nonnull const CJZFImageCoderWebImageContext API_DEPRECATED("No longer supported. Use CJZFWebImageContextDecodeOptions in loader API to provide options. Use CJZFImageCoderOptions in coder API to retrieve options.", macos(10.10, 10.10), ios(8.0, 8.0), tvos(9.0, 9.0), watchos(2.0, 2.0));
 ...
 */
@protocol CJZFImageCoder <NSObject>
...
/**
 ...
 @note This protocol may supports decode animated image frames. You can use `+[CJZFImageCoderHelper animatedImageWithFrames:]` to produce an animated image with frames.

 @param data The image data to be decoded
 @param options A dictionary containing any decoding options. Pass @{CJZFImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for image. Pass @{CJZFImageCoderDecodeFirstFrameOnly: @(YES)} to decode the first frame only.
 @return The decoded image from data
 */
- (nullable UIImage *)decodedImageWithData:(nullable NSData *)data
                                   options:(nullable CJZFImageCoderOptions *)options;

#pragma mark - Encoding

/**
 Returns YES if this coder can encode some image. Otherwise, it should be passed to another coder.
 For custom coder which introduce new image format, you'd better define a new `CJZFImageFormat` using like this. If you're creating public coder plugin for new image format, also update `https://github.com/rs/CJZFWebImage/wiki/Coder-Plugin-List` to avoid same value been defined twice.
 * @code
 static const CJZFImageFormat CJZFImageFormatHEIF = 10;
 * @endcode
 
 @param format The image format
 @return YES if this coder can encode the image, NO otherwise
 */
- (BOOL)canEncodeToFormat:(CJZFImageFormat)format NS_SWIFT_NAME(canEncode(to:));

/**
 Encode the image to image data.
 @note This protocol may supports encode animated image frames. You can use `+[CJZFImageCoderHelper framesFromAnimatedImage:]` to assemble an animated image with frames. But this consume time is not always reversible. In 5.15.0, we introduce `encodedDataWithFrames` API for better animated image encoding. Use that instead.
 @note Which means, this just forward to `encodedDataWithFrames([CJZFImageFrame(image: image, duration: 0], image.cjzf_imageLoopCount))`

 @param image The image to be encoded
 @param format The image format to encode, you should note `CJZFImageFormatUndefined` format is also  possible
 @param options A dictionary containing any encoding options. Pass @{CJZFImageCoderEncodeCompressionQuality: @(1)} to specify compression quality.
 @return The encoded image data
 */
- (nullable NSData *)encodedDataWithImage:(nullable UIImage *)image
                                   format:(CJZFImageFormat)format
                                  options:(nullable CJZFImageCoderOptions *)options;
...
/**
 ...
 @param loopCount The final animated image loop count. 0 means infinity loop. This config ignore each frame's `cjzf_imageLoopCount`
 @param format The image format to encode, you should note `CJZFImageFormatUndefined` format is also  possible
 @param options A dictionary containing any encoding options. Pass @{CJZFImageCoderEncodeCompressionQuality: @(1)} to specify compression quality.
 @return The encoded image data
 */
- (nullable NSData *)encodedDataWithFrames:(nonnull NSArray<CJZFImageFrame *>*)frames
...
/**
 ...
 @note Pay attention that these methods are not called from main queue.
 */
@protocol CJZFProgressiveImageCoder <CJZFImageCoder>
...
/**
 ...
 @param options A dictionary containing any progressive decoding options (instance-level). Pass @{CJZFImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for progressive animated image (each frames should use the same scale).
 @return A new instance to do incremental decoding for the specify image format
 */
- (nonnull instancetype)initIncrementalWithOptions:(nullable CJZFImageCoderOptions *)options;
...
/**
 ...
 @note Due to the performance issue for progressive decoding and the integration for image view. This method may only return the first frame image even if the image data is animated image. If you want progressive animated image decoding, conform to `CJZFAnimatedImageCoder` protocol as well and use `animatedImageFrameAtIndex:` instead.

 @param options A dictionary containing any progressive decoding options. Pass @{CJZFImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for progressive image
 @return The decoded image from current data
 */
- (nullable UIImage *)incrementalDecodedImageWithOptions:(nullable CJZFImageCoderOptions *)options;

@end

#pragma mark - Animated Image Provider
/**
 This is the animated image protocol to provide the basic function for animated image rendering. It's adopted by `CJZFAnimatedImage` and `CJZFAnimatedImageCoder`
 */
@protocol CJZFAnimatedImageProvider <NSObject>
...
/**
 This is the animated image coder protocol for custom animated image class like  `CJZFAnimatedImage`. Through it inherit from `CJZFImageCoder`. We currentlly only use the method `canDecodeFromData:` to detect the proper coder for specify animated image format.
 */
@protocol CJZFAnimatedImageCoder <CJZFImageCoder, CJZFAnimatedImageProvider>
...
/**
 ...
 After the instance created, we may call methods in `CJZFAnimatedImageProvider` to produce animated image frame.

 @param data The animated image data to be decode
 @param options A dictionary containing any animated decoding options (instance-level). Pass @{CJZFImageCoderDecodeScaleFactor: @(1.0)} to specify scale factor for animated image (each frames should use the same scale).
 @return A new instance to do animated decoding for specify image data
 */
- (nullable instancetype)initWithAnimatedImageData:(nullable NSData *)data options:(nullable CJZFImageCoderOptions *)options;
