...
/**
 ...
 For a full GIF support, we recommend `CJZFAnimatedImageView` to keep both CPU and memory balanced.
 ...
 */
@interface CJZFImageIOCoder : NSObject <CJZFProgressiveImageCoder>

@property (nonatomic, class, readonly, nonnull) CJZFImageIOCoder *sharedCoder;
