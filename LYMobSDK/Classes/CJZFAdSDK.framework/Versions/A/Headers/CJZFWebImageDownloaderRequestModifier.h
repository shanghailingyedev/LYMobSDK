...
typedef NSURLRequest * _Nullable (^CJZFWebImageDownloaderRequestModifierBlock)(NSURLRequest * _Nonnull request);
 ...
 */
@protocol CJZFWebImageDownloaderRequestModifier <NSObject>
 ...
 */
@interface CJZFWebImageDownloaderRequestModifier : NSObject <CJZFWebImageDownloaderRequestModifier>

/// Create the request modifier with block
/// @param block A block to control modifier logic
- (nonnull instancetype)initWithBlock:(nonnull CJZFWebImageDownloaderRequestModifierBlock)block;

/// Create the request modifier with block
/// @param block A block to control modifier logic
+ (nonnull instancetype)requestModifierWithBlock:(nonnull CJZFWebImageDownloaderRequestModifierBlock)block;
...
*/
@interface CJZFWebImageDownloaderRequestModifier (Conveniences)
