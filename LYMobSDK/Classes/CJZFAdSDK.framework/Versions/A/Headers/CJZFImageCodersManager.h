...
/**
 ...
 Coders
 ------
 A coder must conform to the `CJZFImageCoder` protocol or even to `CJZFProgressiveImageCoder` if it supports progressive decoding
 ...
 */
@interface CJZFImageCodersManager : NSObject <CJZFImageCoder>

/**
 Returns the global shared coders manager instance.
 */
@property (nonatomic, class, readonly, nonnull) CJZFImageCodersManager *sharedManager;
 ...
 */
@property (nonatomic, copy, nullable) NSArray<id<CJZFImageCoder>> *coders;
...
/**
 ...
 @param coder coder
 */
- (void)addCoder:(nonnull id<CJZFImageCoder>)coder;
...
/**
 ...
 @param coder coder
 */
- (void)removeCoder:(nonnull id<CJZFImageCoder>)coder;
