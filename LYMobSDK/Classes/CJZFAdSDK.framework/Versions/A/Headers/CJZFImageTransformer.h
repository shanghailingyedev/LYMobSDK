...
#import "UIImage+CJZFTransform.h"
 ...
 */
FOUNDATION_EXPORT NSString * _Nullable CJZFTransformedKeyForKey(NSString * _Nullable key, NSString * _Nonnull transformerKey);
...
/**
 ...
 @note If you have both transformer and thumbnail applied for image, call `CJZFThumbnailedKeyForKey` firstly and then with `CJZFTransformedKeyForKey`.`
 */
FOUNDATION_EXPORT NSString * _Nullable CJZFThumbnailedKeyForKey(NSString * _Nullable key, CGSize thumbnailPixelSize, BOOL preserveAspectRatio);

/**
 A transformer protocol to transform the image load from cache or from download.
 You can provide transformer to cache and manager (Through the `transformer` property or context option `CJZFWebImageContextImageTransformer`).
 
 @note The transform process is called from a global queue in order to not to block the main queue.
 */
@protocol CJZFImageTransformer <NSObject>
 ...
 */
@interface CJZFImagePipelineTransformer : NSObject <CJZFImageTransformer>

/**
 All transformers in pipeline
 */
@property (nonatomic, copy, readonly, nonnull) NSArray<id<CJZFImageTransformer>> *transformers;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithTransformers:(nonnull NSArray<id<CJZFImageTransformer>> *)transformers;

@end

// There are some built-in transformers based on the `UIImage+CJZFTransformer` category to provide the common image geometry, image blending and image effect process. Those transform are useful for static image only but you can create your own to support animated image as well.
 ...
 */
@interface CJZFImageRoundCornerTransformer: NSObject <CJZFImageTransformer>
 ...
 */
@property (nonatomic, assign, readonly) CJZFRectCorner corners;
...
- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithRadius:(CGFloat)cornerRadius corners:(CJZFRectCorner)corners borderWidth:(CGFloat)borderWidth borderColor:(nullable UIColor *)borderColor;
 ...
 */
@interface CJZFImageResizingTransformer : NSObject <CJZFImageTransformer>
 ...
 */
@property (nonatomic, assign, readonly) CJZFImageScaleMode scaleMode;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithSize:(CGSize)size scaleMode:(CJZFImageScaleMode)scaleMode;
 ...
 */
@interface CJZFImageCroppingTransformer : NSObject <CJZFImageTransformer>
 ...
 */
@interface CJZFImageFlippingTransformer : NSObject <CJZFImageTransformer>
 ...
 */
@interface CJZFImageRotationTransformer : NSObject <CJZFImageTransformer>
 ...
 */
@interface CJZFImageTintTransformer : NSObject <CJZFImageTransformer>
 ...
 */
@interface CJZFImageBlurTransformer : NSObject <CJZFImageTransformer>
 ...
 */
@interface CJZFImageFilterTransformer: NSObject <CJZFImageTransformer>
