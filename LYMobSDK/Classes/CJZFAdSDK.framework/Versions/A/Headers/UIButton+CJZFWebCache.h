...
/**
 * Integrates CJZFWebImage async downloading and caching of remote images with UIButton.
 */
@interface UIButton (CJZFWebCache)

#pragma mark - Image

/**
 * Get the current image URL.
 * This simply translate to `[self cjzf_imageURLForState:self.state]` from v5.18.0
 */
 ...
 */
- (nullable NSURL *)cjzf_imageURLForState:(UIControlState)state;
 ...
 * @param state Which state you want to know the URL for. The values are described in UIControlState.
 */
- (nonnull NSString *)cjzf_imageOperationKeyForState:(UIControlState)state;
 ...
 */
@property (nonatomic, strong, readonly, nullable) NSURL *cjzf_currentBackgroundImageURL;
 ...
 * @param state Which state you want to know the URL for. The values are described in UIControlState.
 */
- (nonnull NSString *)cjzf_backgroundImageOperationKeyForState:(UIControlState)state;
 ...
 * @param state Which state you want to know the URL for. The values are described in UIControlState.
 */
- (nullable NSURL *)cjzf_backgroundImageURLForState:(UIControlState)state;
 ...
 * @param state The state that uses the specified title. The values are described in UIControlState.
 */
- (void)cjzf_setBackgroundImageWithURL:(nullable NSURL *)url
                            forState:(UIControlState)state NS_REFINED_FOR_SWIFT;
 ...
 */
- (void)cjzf_cancelImageLoadForState:(UIControlState)state;

/**
 * Cancel the current backgroundImage download
 */
- (void)cjzf_cancelBackgroundImageLoadForState:(UIControlState)state;
