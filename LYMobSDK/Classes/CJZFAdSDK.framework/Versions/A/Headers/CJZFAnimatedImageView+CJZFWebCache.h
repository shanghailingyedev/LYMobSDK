...
#import "CJZFAnimatedImageView.h"
...
/**
 Integrates CJZFWebImage async downloading and caching of remote images with CJZFAnimatedImageView.
 */
@interface CJZFAnimatedImageView (CJZFWebCache)
