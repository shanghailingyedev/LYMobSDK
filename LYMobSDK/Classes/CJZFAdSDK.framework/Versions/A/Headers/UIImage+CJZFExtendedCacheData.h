...
@interface UIImage (CJZFExtendedCacheData)
...
/**
 ...
 @note The disk cache preserve both of the data and extended data with the same cache key. For manual query, use the `CJZFDiskCache` protocol method `extendedDataForKey:` instead.
 ...
 */
@property (nonatomic, strong, nullable) id<NSObject, NSCoding> cjzf_extendedObject;
