...
typedef NS_ENUM(NSInteger, CJZFWebImageDownloaderExecutionOrder) {
    /**
     * Default value. All download operations will execute in queue style (first-in-first-out).
     */
    CJZFWebImageDownloaderFIFOExecutionOrder,
    
    /**
     * All download operations will execute in stack style (last-in-first-out).
     */
    CJZFWebImageDownloaderLIFOExecutionOrder
};
 ...
 */
@interface CJZFWebImageDownloaderConfig : NSObject <NSCopying>

/**
 Gets the default downloader config used for shared instance or initialization when it does not provide any downloader config. Such as `CJZFWebImageDownloader.sharedDownloader`.
 ...
 */
@property (nonatomic, class, readonly, nonnull) CJZFWebImageDownloaderConfig *defaultDownloaderConfig;
...
/**
 * Gets/Sets a subclass of `CJZFWebImageDownloaderOperation` as the default
 * `NSOperation` to be used each time CJZFWebImage constructs a request
 * operation to download an image.
 * Defaults to nil.
 * @note Passing `NSOperation<CJZFWebImageDownloaderOperation>` to set as default. Passing `nil` will revert to `CJZFWebImageDownloaderOperation`.
 */
@property (nonatomic, assign, nullable) Class operationClass;

/**
 * Changes download operations execution order.
 * Defaults to `CJZFWebImageDownloaderFIFOExecutionOrder`.
 */
@property (nonatomic, assign) CJZFWebImageDownloaderExecutionOrder executionOrder;
