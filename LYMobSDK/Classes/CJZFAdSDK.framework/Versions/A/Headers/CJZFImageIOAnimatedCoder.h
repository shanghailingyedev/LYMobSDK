 ...
 */
@interface CJZFImageIOAnimatedCoder : NSObject <CJZFProgressiveImageCoder, CJZFAnimatedImageCoder>

#pragma mark - Subclass Override
/**
 The supported animated image format. Such as `CJZFImageFormatGIF`.
 @note Subclass override.
 */
@property (class, readonly) CJZFImageFormat imageFormat;
/**
 The supported image format UTI Type. Such as `kCJZFUTTypeGIFGIF`.
 This can be used for cases when we can not detect `CJZFImageFormat. Such as progressive decoding's hint format `kCGImageSourceTypeIdentifierHint`.
 @note Subclass override.
 */
