...
typedef NSURLResponse * _Nullable (^CJZFWebImageDownloaderResponseModifierBlock)(NSURLResponse * _Nonnull response);
 ...
 */
@protocol CJZFWebImageDownloaderResponseModifier <NSObject>
...
/// @note If nil is returned, the image download will marked as cancelled with error `CJZFWebImageErrorInvalidDownloadResponse`
 ...
 */
@interface CJZFWebImageDownloaderResponseModifier : NSObject <CJZFWebImageDownloaderResponseModifier>

/// Create the response modifier with block
/// @param block A block to control modifier logic
- (nonnull instancetype)initWithBlock:(nonnull CJZFWebImageDownloaderResponseModifierBlock)block;

/// Create the response modifier with block
/// @param block A block to control modifier logic
+ (nonnull instancetype)responseModifierWithBlock:(nonnull CJZFWebImageDownloaderResponseModifierBlock)block;
...
*/
@interface CJZFWebImageDownloaderResponseModifier (Conveniences)
