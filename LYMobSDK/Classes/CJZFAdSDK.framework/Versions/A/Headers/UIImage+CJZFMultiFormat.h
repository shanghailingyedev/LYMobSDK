 ...
 */
@interface UIImage (CJZFMultiFormat)
#pragma mark - Decode
/**
 ...
 */
+ (nullable UIImage *)cjzf_imageWithData:(nullable NSData *)data;
...
/**
 ...
 @return The created image
 */
+ (nullable UIImage *)cjzf_imageWithData:(nullable NSData *)data scale:(CGFloat)scale;
...
/**
 ...
 @return The created image
 */
+ (nullable UIImage *)cjzf_imageWithData:(nullable NSData *)data scale:(CGFloat)scale firstFrameOnly:(BOOL)firstFrameOnly;

#pragma mark - Encode
/**
 Encode the current image to the data, the image format is unspecified

 @note If the receiver is `CJZFAnimatedImage`, this will return the animated image data if available. No more extra encoding process.
 @note For macOS, if the receiver contains only `CJZFAnimatedImageRep`, this will return the animated image data if available. No more extra encoding process.
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)cjzf_imageData;
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)cjzf_imageDataAsFormat:(CJZFImageFormat)imageFormat NS_SWIFT_NAME(cjzf_imageData(as:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)cjzf_imageDataAsFormat:(CJZFImageFormat)imageFormat compressionQuality:(double)compressionQuality NS_SWIFT_NAME(cjzf_imageData(as:compressionQuality:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)cjzf_imageDataAsFormat:(CJZFImageFormat)imageFormat compressionQuality:(double)compressionQuality firstFrameOnly:(BOOL)firstFrameOnly NS_SWIFT_NAME(cjzf_imageData(as:compressionQuality:firstFrameOnly:));
