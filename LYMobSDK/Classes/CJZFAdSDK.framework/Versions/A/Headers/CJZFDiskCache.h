...
/**
 A protocol to allow custom disk cache used in CJZFImageCache.
 */
@protocol CJZFDiskCache <NSObject>
 ...
 */
- (nullable instancetype)initWithCachePath:(nonnull NSString *)cachePath config:(nonnull CJZFImageCacheConfig *)config;
 ...
 */
@interface CJZFDiskCache : NSObject <CJZFDiskCache>
/**
 Cache Config object - storing all kind of settings.
 */
@property (nonatomic, strong, readonly, nonnull) CJZFImageCacheConfig *config;
