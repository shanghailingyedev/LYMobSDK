...
typedef NS_ENUM(NSUInteger, CJZFImageScaleMode) {
    /// The option to scale the content to fit the size of itself by changing the aspect ratio of the content if necessary.
    CJZFImageScaleModeFill = 0,
    /// The option to scale the content to fit the size of the view by maintaining the aspect ratio. Any remaining area of the view’s bounds is transparent.
    CJZFImageScaleModeAspectFit = 1,
    /// The option to scale the content to fill the size of the view. Some portion of the content may be clipped to fill the view’s bounds.
    CJZFImageScaleModeAspectFill = 2
};

#if CJZF_UIKIT || CJZF_WATCH
typedef UIRectCorner CJZFRectCorner;
#else
typedef NS_OPTIONS(NSUInteger, CJZFRectCorner) {
    CJZFRectCornerTopLeft     = 1 << 0,
    CJZFRectCornerTopRight    = 1 << 1,
    CJZFRectCornerBottomLeft  = 1 << 2,
    CJZFRectCornerBottomRight = 1 << 3,
    CJZFRectCornerAllCorners  = ~0UL
};
#endif
 ...
 */
@interface UIImage (CJZFTransform)
 ...
 */
- (nullable UIImage *)cjzf_resizedImageWithSize:(CGSize)size scaleMode:(CJZFImageScaleMode)scaleMode;
 ...
 */
- (nullable UIImage *)cjzf_croppedImageWithRect:(CGRect)rect;
 ...
 */
- (nullable UIImage *)cjzf_roundedCornerImageWithRadius:(CGFloat)cornerRadius
                                              corners:(CJZFRectCorner)corners
 ...
 */
- (nullable UIImage *)cjzf_rotatedImageWithAngle:(CGFloat)angle fitSize:(BOOL)fitSize;
 ...
 */
- (nullable UIImage *)cjzf_flippedImageWithHorizontal:(BOOL)horizontal vertical:(BOOL)vertical;
 ...
 */
- (nullable UIImage *)cjzf_tintedImageWithColor:(nonnull UIColor *)tintColor;
 ...
 */
- (nullable UIColor *)cjzf_colorAtPoint:(CGPoint)point;
...
/**
 ...
 @note The rect's width/height should not be smaller than or equal to 0. The minX/minY should not be smaller than 0. The maxX/maxY should not be greater than width/height. Attention this limit is different from `cjzf_colorAtPoint:` (point: (0, 0) like rect: (0, 0, 1, 1))
 @note The overhead of object creation means this method is best suited for infrequent color sampling. For heavy image processing, grab the raw bitmap data and process yourself.

 @param rect The rectangle of pixels
 @return The color array for specify pixels, or nil if any error occur
 */
- (nullable NSArray<UIColor *> *)cjzf_colorsWithRect:(CGRect)rect;
 ...
 */
- (nullable UIImage *)cjzf_blurredImageWithRadius:(CGFloat)blurRadius;
...
/**
 ...
 enough memory).
 */
- (nullable UIImage *)cjzf_filteredImageWithFilter:(nonnull CIFilter *)filter;
#endif
