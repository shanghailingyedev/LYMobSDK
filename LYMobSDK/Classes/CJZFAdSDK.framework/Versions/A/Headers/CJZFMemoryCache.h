...
@class CJZFImageCacheConfig;
/**
 A protocol to allow custom memory cache used in CJZFImageCache.
 */
@protocol CJZFMemoryCache <NSObject>
 ...
 */
- (nonnull instancetype)initWithConfig:(nonnull CJZFImageCacheConfig *)config;
 ...
 */
@interface CJZFMemoryCache <KeyType, ObjectType> : NSCache <KeyType, ObjectType> <CJZFMemoryCache>

@property (nonatomic, strong, nonnull, readonly) CJZFImageCacheConfig *config;
