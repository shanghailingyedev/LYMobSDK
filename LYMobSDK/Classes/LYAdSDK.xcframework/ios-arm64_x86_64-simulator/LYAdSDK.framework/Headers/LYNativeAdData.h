...
@interface LYImageInfo : NSObject
...
@interface LYVideoInfo : NSObject
...
@interface LYNativeAdData : NSObject
...
/// 广告图片对象集合
@property (nonatomic, strong, readonly) NSArray <LYImageInfo *>*images;

/// 是否是视频类广告
@property (nonatomic, assign, readonly) BOOL isVideoAd;

/// 视频类素材描述
@property (nonatomic, strong, readonly) LYVideoInfo *videoAdInfo;
