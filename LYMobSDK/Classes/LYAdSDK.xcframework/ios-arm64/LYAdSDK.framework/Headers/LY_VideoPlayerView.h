...
#import <LYAdSDK/LY_Macro.h>

NS_ASSUME_NONNULL_BEGIN

@interface LYVideoPlayerView : UIView
 ...
 */
- (void)setStateCallback:(nullable LYVideoPlayerStateCallback)callback;

/**
 * 设置视频播放进度回调
 * @param callback 进度变化时的回调，间隔（1秒）
 */
- (void)setProgressCallback:(nullable LYVideoPlayerProgressCallback)callback;
 ...
 */
- (LYVideoPlayerState)playerState;
