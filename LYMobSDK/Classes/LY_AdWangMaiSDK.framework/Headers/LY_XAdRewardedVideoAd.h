...
@protocol LY_XAdRewardedVideoDelegate;

@interface LY_XAdRewardedVideoAd : NSObject

/// 代理
@property (nonatomic,weak) id<LY_XAdRewardedVideoDelegate>delegate;
