...
@protocol LY_XAdInterstitialDelegate;

@interface LY_XAdInterstitialAd : NSObject

/// 代理
@property (weak, nonatomic) id<LY_XAdInterstitialDelegate>delegate;
